  ...
  return (
    <div className="w-full">
      <div className="relative mb-2 w-full pt-[56%]">
        ...
        <span className="absolute bottom-1 right-1 inline-block rounded bg-black dark:bg-white px-1.5 text-sm">
      ...
      <div className="flex gap-x-2">
        ...
        <div className="w-full">
          ...
          <span className="flex text-sm text-gray-400 dark:text-gray-500">
