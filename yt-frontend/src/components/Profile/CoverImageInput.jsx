...
function CoverImageInput({ children, setCoverImage, coverImage }) {
  ...
  return (
    <div
      className="w-full h-full mb-4 rounded-lg bg-cover bg-center bg-no-repeat items-center relative"
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full flex justify-center items-center">
          ...
          {coverPic && (
            <button
              ...
              } rounded-full bg-slate-100 dark:bg-gray-800 text-orange-500 hover:text-orange-600 p-2`}
        ...
        <div
          ...
          } absolute right-0 bottom-0 bg-white/90 dark:bg-gray-800 text-orange-500 flex items-center gap-1 rounded-tl-md px-2 text-center font-semibold`}
        >
          Cover
