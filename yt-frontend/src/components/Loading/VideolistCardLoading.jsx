...
function VideolistCardLoading() {
  return (
    <div className="flex w-full max-w-3xl space-x-4 animate-pulse bg-white dark:bg-black text-black dark:text-white">
      <div className="flex-none w-5/12">
        <div className="w-full h-0 pb-[56.25%] bg-gray-300 dark:bg-gray-700 rounded"></div>
      </div>
