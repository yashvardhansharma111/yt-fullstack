  ...
  return (
    <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
      ...
      <div className="px-4 pb-4">
          ...
          <div className="inline-block">
            <div className="inline-flex min-w-[145px] justify-end">
              <Link
                ...
                className="px-4 py-1.5 text-sm text-white bg-orange-600 hover:bg-orange-700 rounded-md"
              >
                View Channel
              </Link>
            </div>
        ...
        <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-white dark:bg-[#121212] dark:border-gray-700 py-2 sm:top-[82px]">
          {editProfileItems.map((item, index) => (
            <li key={index} className="w-full">
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "w-full border-b-2 border-orange-600 bg-white dark:bg-gray-800 px-3 py-1.5 text-orange-600"
                    : "w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400 dark:text-gray-400"
                }
              >
                {item.name}
              </NavLink>
