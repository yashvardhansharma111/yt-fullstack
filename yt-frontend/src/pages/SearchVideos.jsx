...
function SearchVideos() {
  ...
  if (isError) {
    return (
      <div className="flex w-full justify-center items-center h-screen text-gray-900 dark:text-white">
  ...
  if (allVideos.length === 0) {
    return (
      <div className="flex justify-center items-center w-full h-screen text-gray-900 dark:text-white">
    ...
    <div className="min-h-screen w-full dark:bg-gray-900 bg-gray-100">
      <div className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            className="flex items-center space-x-2 text-orange-500 dark:text-orange-400 hover:text-orange-600 dark:hover:text-orange-300 transition-colors duration-200"
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={() => setFilterOpen(false)}>
                  <IoCloseCircleOutline
                    size={24}
                    className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-white transition-colors duration-200"
                  />
                </button>
              </div>
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white border-b border-gray-300 dark:border-gray-600 pb-2">
                  Sort By
                </h3>
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={item.label}>
                      <button
                        className="text-gray-700 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400 transition-colors duration-200 w-full text-left"
                        onClick={() => {
