  ...
  return (
    <div className="flex flex-col sm:flex-row w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
      <section className="w-3/4 pr-4">
        <h1 className="text-3xl font-bold my-2 ml-4 dark:text-white">History</h1>
      ...
      <aside className="w-full sm:w-1/4 p-4">
        <div className="relative mb-4">
          <input
            ...
            className="w-full bg-gray-100 dark:bg-gray-800 dark:text-white text-gray-800 border border-orange-500 rounded-md py-2 px-4 pl-10 focus:outline-none focus:ring-2 focus:ring-orange-600"
          />
          <BiSearch className="absolute h-6 w-6 left-3 top-2.5 text-orange-400" />
        </div>
